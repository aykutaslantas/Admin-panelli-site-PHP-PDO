                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="referans.php">Referanslar</a>
                                </nav>
                            </div>
                            <a class="nav-link" href="iletisimformu.php">İletişim Formu</a>
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#hakkimizda" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Hakkımızda
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            ...
                            if($_SESSION["yetki"]==1){
                            ?>
                            <a class="nav-link" href="servisa.php">Servis</a>
                            <?php
                            ...
                            if($_SESSION["yetki"]==1){
                            ?>
                            <a class="nav-link" href="hakkimizdaa.php">Hakkımızda</a>
                            <?php
                            ...
                            if($_SESSION["yetki"]==1){
                            ?>
                            <a class="nav-link" href="portfolyoa.php">Portfolyo</a>
                            <?php
